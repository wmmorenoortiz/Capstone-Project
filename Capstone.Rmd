...
### **Step 3:** Choose the Model and train the model with the training base.
...
set.seed(755)
test_index <- createDataPartition(y = database, times = 1,
                                  p = 0.2, list = FALSE)

train_set <- new_edx[-test_index,]
test_set <- new_edx[test_index,]
